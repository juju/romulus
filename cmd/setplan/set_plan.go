...
// The setplan package contains the implementation of the
// juju-set-plan command which get the metrics collection
// credentials from JaaS and sets credentials on the
// specified service.
package setplan
